...
from project.models import User, PalacouloDoorStatus, PortoDoorStatus
from project.api import bp
from flask import url_for
from project import db
from project.api.apierrors import bad_request
from project.api.auth import token_auth
